# Brief — Lanzamiento fórmula mejorada Ultra Efecto Gel × Fénix + Promo 1 esmalte por $1 (SOLO POR HOY)

Fuente única de verdad para Poppy, WhatsApp Marketing, Email Marketing y diseño.
Todo lo que no está acá, no existe. No se inventa.

---

## 1. Los dos mensajes de la campaña

La campaña tiene DOS capas que conviven. Ninguna reemplaza a la otra.

| Capa | Mensaje | Rol |
|---|---|---|
| **PROMO** | 1 Esmalte Ultra Efecto Gel por $1 — SOLO POR HOY | Hero / conversión |
| **LANZAMIENTO** | Nueva fórmula mejorada del color Ultra Efecto Gel: ahora se combina con el Tratamiento Fénix | Razón para creer / deseo |

El vínculo entre las dos: **el esmalte que te llevás por $1 es la nueva fórmula.**
→ "Probá la nueva fórmula por $1."

---

## 2. PROMO — datos exactos

**Oferta:** 1 Esmalte Ultra Efecto Gel por $1.
**Condición:** comprando cualquier combo de MiLuz disponible en la web.
**Urgencia:** SOLO POR HOY.
**Color:** sorpresa, de la selección de temporada actual.
**Legal:** no acumulable con cupones de descuento.

### Jerarquía de lectura (en este orden)

1. ¿Qué me llevo? → Esmalte Ultra Efecto Gel
2. ¿Cuánto pago? → $1
3. ¿Qué tengo que hacer? → Comprar cualquier combo de MiLuz
4. ¿Por qué ahora? → SOLO POR HOY
...
### Reglas duras de la promo

- "1 ESMALTE POR $1" (o su variante con "ULTRA EFECTO GEL") es siempre protagonista.
- "SOLO POR HOY" es la única urgencia permitida.
- ❌ NO decir "comprá un esmalte por $1" como si se vendiera suelto. El $1 aplica **con un combo**.
- ✅ Decir "comprando cualquier combo, llevate un Esmalte Ultra Efecto Gel por $1".
- No cambiar "$1" por otro precio ni por "gratis".
- No agregar unidades, regalos, envío gratis, descuentos extra ni condiciones.
- No prometer un color específico. Siempre "color sorpresa de la selección de temporada".
- No inventar "últimas unidades", "hasta las 23:59", "últimas horas", stock ni cantidad.
- "No acumulable con cupones" va como legal, chico, nunca compite con el hero.

---

## 3. LANZAMIENTO — qué es y qué NO es

### Lo que cambió

Antes, la comunicación era secuencial: **primero reparás (Fénix), después embellecés (color).**
Ahora, la **fórmula mejorada del color Ultra Efecto Gel se combina con el Tratamiento Fénix**, así que podés hacer las dos cosas **al mismo tiempo**: Fénix trabaja en la reparación mientras vos lucís el efecto gel.

### El matiz que no se puede perder
...
- Tratamiento Fénix
- Tratamiento fortalecedor y reparador para uñas débiles y dañadas (nombre real en la web)
- "repara", "fortalece", "trabaja en tu uña"
...
## 4. Cómo conviven las dos capas en una pieza

Tres modos. Poppy tiene que explorar los tres.
...
Regla: en cualquier modo, la pieza tiene que dejar claro **qué me llevo, cuánto pago, qué hago y por qué hoy** en menos de 3 segundos.

---

## 5. Sistema de presentación de la oferta (jerarquías a testear)

Misma oferta real, distintas formas de leerla. Ninguna cambia la promo.

| Código | Nombre | Headline | Subline |
|---|---|---|---|
| **A** | PRICE FIRST | **$1** / 1 ESMALTE / SOLO POR HOY | Comprando cualquier combo |
...
## 7. Pendientes a confirmar (Luz)

- [ ] ¿Todos los combos de la web incluyen Fénix? Si **no**, la narrativa "reparás mientras lucís" se comunica como **compatibilidad** ("ahora el color se combina con Fénix"), no como promesa de que el combo repara.
